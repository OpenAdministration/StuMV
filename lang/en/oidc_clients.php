...
return [
    ...
    'post_logout_redirect_uris_description' => 'Optional, one URL per line. Destinations the client may be redirected back to after ending a session through the end-session endpoint.',
