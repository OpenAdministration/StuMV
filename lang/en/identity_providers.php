...
return [
    ...
    'extra_authorize_params_description' => 'Optional: additional query parameters for the authorize URL, one "key=value" per line (e.g. "kc_idp_hint=my-upstream-idp" for Keycloak, to jump straight to an upstream IdP configured there).',
    'extra_authorize_params_invalid_line' => 'Invalid format on line ":line" - expected "key=value".',
    'enabled' => 'Enabled',
    'status' => 'Status',
