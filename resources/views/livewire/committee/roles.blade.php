<div class="flex-col space-y-8" wire:init="loadRoles">
    ...
    <div
        ...
        x-data="persistedToggle('showOnlyActive', 'committees.showOnlyActive', false)"
    >
        ...
        <flux:modal name="delete" class="md:w-96">
            <div class="space-y-6">
                <div>
                    ...
                    <flux:text class="mt-2">{{ __('roles.delete.confirm') }}<strong>{{ $deleteRoleCn }}</strong></flux:text>
                    <flux:field class="mt-4">
                        <flux:input
                            wire:model="deleteConfirmText"
                            :placeholder="$deleteRoleCn"
                        />
