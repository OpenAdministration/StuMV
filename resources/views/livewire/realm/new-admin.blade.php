<div>
    <x-livewire-form>
        <div class="mb-8">
            <flux:heading size="xl" class="mb-4">{{ __('realms.new_admin_headline', ['name' => $community->getFirstAttribute('description'), 'uid' => $realm_uid]) }}</flux:heading>
            <flux:text class="text-base">{{ __('realms.new_admin_explanation') }}</flux:text>
        </div>
