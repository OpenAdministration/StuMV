...
<ui-select data-editor="heading" class="relative">
    <flux:tooltip content="{{ __('Styles') }}" :$kbd class="contents">
        <flux:editor.button>
            <ui-selected>
                ...
                <div class="in-[ui-selected]:sr-only">{{ __('Text') }}</div>
            </ui-selected>
    ...
    <ui-options popover="manual" aria-label="{{ __('Styles') }}" class="min-w-40 rounded-lg border border-zinc-200 dark:border-zinc-600 bg-white dark:bg-zinc-700 shadow-xs p-[5px]">
        ...
        <flux:editor.option value="heading1">
            ...
            <div class="in-[ui-selected]:sr-only">{{ __('Heading 1') }}</div>
        </flux:editor.option>
        ...
        <flux:editor.option value="heading2">
            ...
            <div class="in-[ui-selected]:sr-only">{{ __('Heading 2') }}</div>
        </flux:editor.option>
        ...
        <flux:editor.option value="heading3">
            ...
            <div class="in-[ui-selected]:sr-only">{{ __('Heading 3') }}</div>
        </flux:editor.option>
    </ui-options>
</ui-select>
