...
$classes = Flux::classes()
    ...
    ->add([
        '[--haze:color-mix(in_oklab,var(--color-accent-content),transparent_97.5%)]',
        '[--haze-border:color-mix(in_oklab,var(--color-accent-content),transparent_80%)]',
        '[--haze-light:color-mix(in_oklab,var(--color-accent),transparent_98%)]',
        'dark:[--haze:color-mix(in_oklab,var(--color-accent-content),transparent_90%)]',
    ])
    ->add(match ($accent) {
        true => [
            '[&:hover_[data-flux-checkbox-indicator]]:border-(--haze-border) dark:[&:hover_[data-flux-checkbox-indicator]]:border-white/10',
            'hover:border-(--haze-border) dark:hover:border-white/10',

            'data-checked:border-(--color-accent) hover:data-checked:border-(--color-accent) dark:data-checked:bg-white/15 ',
            'hover:after:bg-(--haze-light) dark:hover:after:bg-white/4 data-checked:after:bg-(--haze) hover:data-checked:after:bg-(--haze)',
        ],
        false => [
